...
public class GetHintButtonTest {
    ...
    public void getHintButtonTest() {
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.getHintButton), withText("Feeling Confident"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction button2 = onView(
                allOf(withId(R.id.randomButton), withText("Random"),
                        childAtPosition(
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.getHintButton), withText("Get Hint"),
                        childAtPosition(
                                childAtPosition(
